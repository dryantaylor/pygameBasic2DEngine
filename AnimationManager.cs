using namespace EngineFramework.Rendering
{
	public class AnimationManager
    {
        ...
        public bool AddAnimation(string name, IntPtr[] frames, int[] timings, bool doesLoop = false)
        {
        ...
        public bool AddAnimation(string name, string[] framePaths, int[] timings, bool doesLoop = false)
        {
            if (animations.ContainsKey(name))
            {
                return false;
            ...
            animations[name] = new Animation(framePaths, timings, doesLoop, Renderer);
            return true;
        }
        ...
        public IntPtr GetNextFrame(int deltaTimeMS)
        {
            time += deltaTimeMS;
            while (true)
            {
